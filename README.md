...
With UI tests, you can not rely solely on the log files. In order to really understand mistakes, screenshots are helpful and important. The combination of Vaadin and Selenium also makes this easy, as this part of the column "Backend meets Frontend" shows.
...
* german article [http://bit.ly/jaxenter-004](http://bit.ly/jaxenter-004)
